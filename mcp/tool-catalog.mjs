...
export const TOOL_CATALOG = [
  ...
  },
  {
    ...
    description:
      'List Topview generation models by default (Higgsfield only when explicitly requested), including image, video, and audio reference inputs. Seedance 2.5 accepts all three; audio references are input guidance, separate from generated sound. Use before cinegen_generate.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        prompt: string('Shot description saved in Studio. Optional for lip sync, upscaling, and audio-driven avatars.'),
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        prompt: string('Required when the selected model requires a prompt. Optional for lip sync, upscaling, and audio-driven avatars.'),
