...
const MODEL_REGISTRY = {
  ...
  "layer-decompose-cloud": {
    ...
    category: "image-edit",
    description: "Decompose image into layers — SAM 3 + Qwen Edit via fal.ai cloud",
    outputType: "image",
    provider: "fal",
    responseMapping: { path: "masks.0.url" },
    inputs: [
      { id: "image_url", portType: "image", label: "Image", required: true, falParam: "image_url", fieldType: "port" },
      { id: "prompts", portType: "text", label: "Prompts", required: false, falParam: "prompt", fieldType: "textarea", default: "" },
      ...
      { id: "max_masks", portType: "number", label: "Max Masks", required: false, falParam: "max_masks", fieldType: "range", default: 10, min: 1, max: 32, step: 1 },
...
const LOCAL_MODEL_REGISTRY = {
  ...
  "layer-decompose": {
    ...
    category: "image-edit",
    description: "Decompose image into layers — SAM 2.1 + PaddleOCR locally on your Mac",
    outputType: "image",
    provider: "local",
    responseMapping: { path: "output_path" },
    inputs: [
