import { H as v } from "./main-NDbCh1MX.js";
const c = {
  "kie-runway": {
    id: "runway",
    nodeType: "kie-runway",
...
function q(e) {
  return T(e) || e === "sora-2" || e === "ltx-2-3-text" || e === "ltx-2-3-image";
}
function w(e, a, l) {
  const i = l.quality ?? "pro";
  return T(e) ? P(e === "kling-3-image" ? "image-to-video" : "text-to-video", i) : e === "sora-2" ? i === "standard" ? "fal-ai/sora-2/image-to-video" : "fal-ai/sora-2/image-to-video/pro" : e === "ltx-2-3-text" ? i === "fast" ? "fal-ai/ltx-2.3/text-to-video/fast" : "fal-ai/ltx-2.3/text-to-video" : e === "ltx-2-3-image" ? i === "fast" ? "fal-ai/ltx-2.3/image-to-video/fast" : "fal-ai/ltx-2.3/image-to-video" : l.hasImageInputs && a.altId ? a.altId : a.id;
}
function F(e, a, l) {
  q(e) && delete l.quality, e === "sora-2" && !a.endsWith("/pro") && (l.resolution === "1080p" || l.resolution === "true_1080p") && (l.resolution = "720p");
}
const s = Array.from({ length: 13 }, (e, a) => {
  const l = String(a + 3);
  return { value: l, label: `${l}s` };
}), d = ["6", "8", "10"].map((e) => ({ value: e, label: `${e}s` })), m = ["6", "8", "10", "12", "14", "16", "18", "20"].map((e) => ({ value: e, label: `${e}s` })), p = [
  { value: "24", label: "24" },
  { value: "25", label: "25" },
  { value: "48", label: "48" },
  { value: "50", label: "50" }
  ...
  { value: "8:1", label: "8:1" },
  { value: "1:8", label: "1:8" }
], r = [{ value: "png", label: "PNG" }, { value: "jpeg", label: "JPEG" }], f = [...r, { value: "webp", label: "WebP" }], b = [
...
], y = [{ value: "5", label: "5s" }, { value: "10", label: "10s" }], k = {
  "flux-dev": {
    id: "fal-ai/flux/dev",
    nodeType: "flux-dev",
    name: "FLUX Dev",
  ...
  "nano-banana-pro": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "1:1", options: g.filter((e) => e.value !== "auto") },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: f },
  ...
  "kling-3-text": {
    ...
    inputs: [
      ...
      { id: "multi_prompt", portType: "multi_prompt", label: "Multi Prompt", required: !1, falParam: "multi_prompt", fieldType: "port" },
      { id: "negative_prompt", portType: "text", label: "Negative Prompt", required: !1, falParam: "negative_prompt", fieldType: "port" },
      { id: "duration", portType: "text", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "5", options: s },
      { id: "quality", portType: "text", label: "Quality", required: !1, falParam: "quality", fieldType: "select", default: "pro", options: u },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "16:9", options: [
        { value: "16:9", label: "16:9" },
        { value: "9:16", label: "9:16" },
        { value: "1:1", label: "1:1" }
  ...
  "ltx-2-video": {
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "image_url", portType: "image", label: "Image", required: !1, falParam: "image_url", fieldType: "port" },
      { id: "duration", portType: "number", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "6", options: d },
  ...
  "ltx-2-3-text-fast": {
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "duration", portType: "number", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "6", options: m },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "16:9", options: [
        { value: "16:9", label: "16:9" },
        { value: "9:16", label: "9:16" }
      ] },
  ...
  "elevenlabs-music": {
    ...
    inputs: [
      ...
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "mp3_44100_128", options: b }
    ]
  },
  "elevenlabs-tts": {
...
export {
  D as ALL_MODELS,
  u as KLING_V3_QUALITY_OPTS,
  M as LOCAL_MODEL_REGISTRY,
  n as LTX23_QUALITY_OPTS,
  k as MODEL_REGISTRY,
  I as POD_MODEL_REGISTRY,
  L as RUNPOD_MODEL_REGISTRY,
  _ as SORA2_QUALITY_OPTS,
  T as isKlingV3NodeType,
  P as resolveKlingV3ModelId,
  w as resolveVideoModelEndpoint,
  F as sanitizeVideoInputsForEndpoint,
