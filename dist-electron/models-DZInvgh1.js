const b = {
...
}, o = Array.from({ length: 13 }, (e, f) => {
  const p = String(f + 3);
  return { value: p, label: `${p}s` };
}), i = ["6", "8", "10"].map((e) => ({ value: e, label: `${e}s` })), d = ["6", "8", "10", "12", "14", "16", "18", "20"].map((e) => ({ value: e, label: `${e}s` })), t = [
  { value: "24", label: "24" },
  { value: "25", label: "25" },
  { value: "48", label: "48" },
  { value: "50", label: "50" }
], y = [{ value: "25", label: "25" }, { value: "50", label: "50" }], r = [
  { value: "1080p", label: "1080p" },
  { value: "1440p", label: "1440p" },
  { value: "2160p", label: "4K" }
], T = [{ value: "1080p", label: "1080p" }, { value: "1440p", label: "1440p" }, { value: "2160p", label: "4K" }], a = [
  ...
  { value: "8:1", label: "8:1" },
  { value: "1:8", label: "1:8" }
], l = [{ value: "png", label: "PNG" }, { value: "jpeg", label: "JPEG" }], u = [...l, { value: "webp", label: "WebP" }], n = [
...
], s = [{ value: "5", label: "5s" }, { value: "10", label: "10s" }], v = {
  "flux-dev": {
    id: "fal-ai/flux/dev",
    nodeType: "flux-dev",
    name: "FLUX Dev",
  ...
  "nano-banana-pro": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "1:1", options: m.filter((e) => e.value !== "auto") },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: u },
  ...
  "nano-banana-2": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "auto", options: g },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: u },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "safety_tolerance", portType: "text", label: "Safety Tolerance", required: !1, falParam: "safety_tolerance", fieldType: "select", default: "4", options: [
        { value: "1", label: "1 (strict)" },
  ...
  "kling-3-text": {
    ...
    inputs: [
      ...
      { id: "multi_prompt", portType: "multi_prompt", label: "Multi Prompt", required: !1, falParam: "multi_prompt", fieldType: "port" },
      { id: "negative_prompt", portType: "text", label: "Negative Prompt", required: !1, falParam: "negative_prompt", fieldType: "port" },
      { id: "duration", portType: "text", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "5", options: o },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "16:9", options: [
        { value: "16:9", label: "16:9" },
        { value: "9:16", label: "9:16" },
        { value: "1:1", label: "1:1" }
  ...
  "ltx-2-video": {
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "image_url", portType: "image", label: "Image", required: !1, falParam: "image_url", fieldType: "port" },
      { id: "duration", portType: "number", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "6", options: i },
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "1080p", options: T },
      { id: "fps", portType: "number", label: "FPS", required: !1, falParam: "fps", fieldType: "select", default: "25", options: y },
      { id: "generate_audio", portType: "number", label: "Generate Audio", required: !1, falParam: "generate_audio", fieldType: "toggle", default: !0 }
    ]
  },
  "ltx-2-3-text": {
    ...
    inputs: [
      ...
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "1080p", options: r },
  ...
  "elevenlabs-music": {
    ...
    inputs: [
      ...
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "mp3_44100_128", options: n }
    ]
  },
  "elevenlabs-tts": {
...
export {
  q as ALL_MODELS,
  c as LOCAL_MODEL_REGISTRY,
  v as MODEL_REGISTRY,
  P as POD_MODEL_REGISTRY,
  _ as RUNPOD_MODEL_REGISTRY
};
