...
const LOCAL_MODEL_REGISTRY = {
  "ltx-local": {
    ...
    inputs: [
      ...
      { id: "num_frames", portType: "number", label: "Frames", required: false, falParam: "num_frames", fieldType: "range", default: 97, min: 9, max: 257, step: 8 },
      { id: "frame_rate", portType: "number", label: "FPS", required: false, falParam: "frame_rate", fieldType: "range", default: 24, min: 12, max: 60, step: 1 },
...
const ALL_MODELS = { ...MODEL_REGISTRY, ...KIE_MODEL_REGISTRY, ...LOCAL_MODEL_REGISTRY };
export {
  ALL_MODELS,
