...
const MODEL_REGISTRY = {
  ...
  "ltx-2-3-text": {
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: true, falParam: "prompt", fieldType: "port" },
      { id: "duration", portType: "text", label: "Duration", required: false, falParam: "duration", fieldType: "select", default: "6", options: [
        { value: "6", label: "6s" },
        { value: "8", label: "8s" },
        { value: "10", label: "10s" }
      ] },
      ...
      { id: "fps", portType: "text", label: "FPS", required: false, falParam: "fps", fieldType: "select", default: "25", options: [
        { value: "24", label: "24" },
        { value: "25", label: "25" },
        { value: "48", label: "48" },
        { value: "50", label: "50" }
