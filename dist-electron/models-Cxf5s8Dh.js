const y = {
  ...
  "kie-veo3": {
    ...
    inputs: [
      ...
      { id: "model", portType: "text", label: "Model", required: !1, falParam: "model", fieldType: "select", default: "veo3_fast", options: [
  ...
  "kie-kling3": {
    ...
    inputs: [
      ...
      { id: "mode", portType: "text", label: "Mode", required: !1, falParam: "mode", fieldType: "select", default: "pro", options: [
...
}, d = Array.from({ length: 13 }, (e, t) => {
  const p = String(t + 3);
  return { value: p, label: `${p}s` };
}), o = ["6", "8", "10"].map((e) => ({ value: e, label: `${e}s` })), u = ["6", "8", "10", "12", "14", "16", "18", "20"].map((e) => ({ value: e, label: `${e}s` })), r = [
  { value: "24", label: "24" },
  { value: "25", label: "25" },
  { value: "48", label: "48" },
  { value: "50", label: "50" }
], T = [{ value: "25", label: "25" }, { value: "50", label: "50" }], i = [
  { value: "1080p", label: "1080p" },
  { value: "1440p", label: "1440p" },
  { value: "2160p", label: "4K" }
], g = [{ value: "1080p", label: "1080p" }, { value: "1440p", label: "1440p" }, { value: "2160p", label: "4K" }], a = [
  ...
  { value: "8:1", label: "8:1" },
  { value: "1:8", label: "1:8" }
], l = [{ value: "png", label: "PNG" }, { value: "jpeg", label: "JPEG" }], n = [...l, { value: "webp", label: "WebP" }], s = [
...
], m = [{ value: "5", label: "5s" }, { value: "10", label: "10s" }], f = [
...
function h(e, t) {
  return `fal-ai/kling-video/v3/${t === "standard" || t === "4k" ? t : "pro"}/${e}`;
}
const c = {
  "flux-dev": {
    id: "fal-ai/flux/dev",
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "image_size", portType: "text", label: "Size", required: !1, falParam: "image_size", fieldType: "select", default: "landscape_4_3", options: a },
      ...
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "jpeg", options: l },
  ...
  "flux-kontext": {
    ...
    inputs: [
      ...
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: l },
      { id: "seed", portType: "number", label: "Seed", required: !1, falParam: "seed", fieldType: "number", default: -1 }
    ]
  },
  "nano-banana-pro": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "1:1", options: b.filter((e) => e.value !== "auto") },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: n },
  ...
  "nano-banana-2": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "auto", options: v },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: n },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "safety_tolerance", portType: "text", label: "Safety Tolerance", required: !1, falParam: "safety_tolerance", fieldType: "select", default: "4", options: [
        { value: "1", label: "1 (strict)" },
  ...
  "kling-3-text": {
    ...
    inputs: [
      ...
      { id: "multi_prompt", portType: "multi_prompt", label: "Multi Prompt", required: !1, falParam: "multi_prompt", fieldType: "port" },
      { id: "negative_prompt", portType: "text", label: "Negative Prompt", required: !1, falParam: "negative_prompt", fieldType: "port" },
      { id: "duration", portType: "text", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "5", options: d },
  ...
  "ltx-2-video": {
    ...
    inputs: [
      ...
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "1080p", options: g },
      { id: "fps", portType: "number", label: "FPS", required: !1, falParam: "fps", fieldType: "select", default: "25", options: T },
      { id: "generate_audio", portType: "number", label: "Generate Audio", required: !1, falParam: "generate_audio", fieldType: "toggle", default: !0 }
    ]
  },
  "ltx-2-3-text": {
    ...
    inputs: [
      ...
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "1080p", options: i },
      { id: "fps", portType: "number", label: "FPS", required: !1, falParam: "fps", fieldType: "select", default: "25", options: r },
      { id: "generate_audio", portType: "number", label: "Generate Audio", required: !1, falParam: "generate_audio", fieldType: "toggle", default: !0 }
    ]
  },
  "ltx-2-3-text-fast": {
  ...
  "elevenlabs-music": {
    ...
    inputs: [
      ...
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "mp3_44100_128", options: s }
    ]
  },
  "elevenlabs-tts": {
...
export {
  S as ALL_MODELS,
  f as KLING_V3_QUALITY_OPTS,
  _ as LOCAL_MODEL_REGISTRY,
  c as MODEL_REGISTRY,
  q as POD_MODEL_REGISTRY,
  P as RUNPOD_MODEL_REGISTRY,
  x as isKlingV3NodeType,
  h as resolveKlingV3ModelId
};
