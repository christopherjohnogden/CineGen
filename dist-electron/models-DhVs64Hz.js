import { H as v, b as c } from "./main-DRuT61WX.js";
const _ = {
  "kie-runway": {
    id: "runway",
    nodeType: "kie-runway",
...
function D(e, a, l) {
  ...
  return g(e) ? q(e === "kling-3-image" ? "image-to-video" : "text-to-video", i) : e === "sora-2" ? i === "standard" ? "fal-ai/sora-2/image-to-video" : "fal-ai/sora-2/image-to-video/pro" : e === "ltx-2-3-text" ? i === "fast" ? "fal-ai/ltx-2.3/text-to-video/fast" : "fal-ai/ltx-2.3/text-to-video" : e === "ltx-2-3-image" ? i === "fast" ? "fal-ai/ltx-2.3/image-to-video/fast" : "fal-ai/ltx-2.3/image-to-video" : l.hasImageInputs && a.altId ? a.altId : a.id;
}
function E(e, a, l) {
  x(e) && delete l.quality, e === "sora-2" && !a.endsWith("/pro") && (l.resolution === "1080p" || l.resolution === "true_1080p") && (l.resolution = "720p");
}
const m = Array.from({ length: 13 }, (e, a) => {
  ...
  { value: "48", label: "48" },
  { value: "50", label: "50" }
], h = [{ value: "25", label: "25" }, { value: "50", label: "50" }], o = [
  { value: "1080p", label: "1080p" },
  { value: "1440p", label: "1440p" },
  { value: "2160p", label: "4K" }
], S = [{ value: "1080p", label: "1080p" }, { value: "1440p", label: "1440p" }, { value: "2160p", label: "4K" }], t = [
...
], T = [{ value: "5", label: "5s" }, { value: "10", label: "10s" }], k = {
  "flux-dev": {
    id: "fal-ai/flux/dev",
    nodeType: "flux-dev",
    name: "FLUX Dev",
  ...
  "nano-banana-2": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "auto", options: M },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: b },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "safety_tolerance", portType: "text", label: "Safety Tolerance", required: !1, falParam: "safety_tolerance", fieldType: "select", default: "4", options: [
        { value: "1", label: "1 (strict)" },
  ...
  "ltx-2-video": {
    ...
    inputs: [
      ...
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "1080p", options: S },
      { id: "fps", portType: "number", label: "FPS", required: !1, falParam: "fps", fieldType: "select", default: "25", options: h },
      { id: "generate_audio", portType: "number", label: "Generate Audio", required: !1, falParam: "generate_audio", fieldType: "toggle", default: !0 }
    ]
  },
  "ltx-2-3-text": {
  ...
  "sora-2": {
    ...
    inputs: [
      ...
      { id: "quality", portType: "text", label: "Quality", required: !1, falParam: "quality", fieldType: "select", default: "pro", options: P },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "auto", options: [
        { value: "auto", label: "Auto" },
        { value: "16:9", label: "16:9" },
        { value: "9:16", label: "9:16" }
  ...
  "topview-video-auto": {
    ...
    inputs: [
      ...
      { id: "image_url", portType: "image", label: "References", required: !1, falParam: "reference_images", fieldType: "port", multiple: !0, mediaRole: "image" },
      { id: "extra_images", portType: "image", label: "More References", required: !1, falParam: "image_urls", fieldType: "element-list", max: 30, mediaRole: "image" },
...
export {
  ...
  L as LOCAL_MODEL_REGISTRY,
  s as LTX23_QUALITY_OPTS,
  k as MODEL_REGISTRY,
  I as POD_MODEL_REGISTRY,
  R as RUNPOD_MODEL_REGISTRY,
  P as SORA2_QUALITY_OPTS,
  g as isKlingV3NodeType,
  q as resolveKlingV3ModelId,
  D as resolveVideoModelEndpoint,
  E as sanitizeVideoInputsForEndpoint,
  x as usesEndpointQualityRouting
};
