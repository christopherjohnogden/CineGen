import { H as v } from "./main-BkgnxYW3.js";
const c = {
  "kie-runway": {
    id: "runway",
    nodeType: "kie-runway",
...
function g(e) {
  return e === "kling-3-text" || e === "kling-3-image";
}
function P(e, a) {
  return `fal-ai/kling-video/v3/${a === "standard" || a === "4k" ? a : "pro"}/${e}`;
}
function q(e) {
  return g(e) || e === "sora-2" || e === "ltx-2-3-text" || e === "ltx-2-3-image";
}
function F(e, a, l) {
  const i = l.quality ?? "pro";
  return g(e) ? P(e === "kling-3-image" ? "image-to-video" : "text-to-video", i) : e === "sora-2" ? i === "standard" ? "fal-ai/sora-2/image-to-video" : "fal-ai/sora-2/image-to-video/pro" : e === "ltx-2-3-text" ? i === "fast" ? "fal-ai/ltx-2.3/text-to-video/fast" : "fal-ai/ltx-2.3/text-to-video" : e === "ltx-2-3-image" ? i === "fast" ? "fal-ai/ltx-2.3/image-to-video/fast" : "fal-ai/ltx-2.3/image-to-video" : l.hasImageInputs && a.altId ? a.altId : a.id;
}
function D(e, a, l) {
  q(e) && delete l.quality, e === "sora-2" && !a.endsWith("/pro") && (l.resolution === "1080p" || l.resolution === "true_1080p") && (l.resolution = "720p");
}
const m = Array.from({ length: 13 }, (e, a) => {
  const l = String(a + 3);
  return { value: l, label: `${l}s` };
}), u = ["6", "8", "10"].map((e) => ({ value: e, label: `${e}s` })), f = ["6", "8", "10", "12", "14", "16", "18", "20"].map((e) => ({ value: e, label: `${e}s` })), p = [
  { value: "24", label: "24" },
  { value: "25", label: "25" },
  { value: "48", label: "48" },
  { value: "50", label: "50" }
], x = [{ value: "25", label: "25" }, { value: "50", label: "50" }], o = [
  { value: "1080p", label: "1080p" },
  { value: "1440p", label: "1440p" },
  { value: "2160p", label: "4K" }
], h = [{ value: "1080p", label: "1080p" }, { value: "1440p", label: "1440p" }, { value: "2160p", label: "4K" }], t = [
  ...
  { value: "8:1", label: "8:1" },
  { value: "1:8", label: "1:8" }
], r = [{ value: "png", label: "PNG" }, { value: "jpeg", label: "JPEG" }], b = [...r, { value: "webp", label: "WebP" }], y = [
...
], T = [{ value: "5", label: "5s" }, { value: "10", label: "10s" }], M = {
  "flux-dev": {
    id: "fal-ai/flux/dev",
    nodeType: "flux-dev",
    name: "FLUX Dev",
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "image_size", portType: "text", label: "Size", required: !1, falParam: "image_size", fieldType: "select", default: "landscape_4_3", options: t },
      ...
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "jpeg", options: r },
  ...
  "flux-kontext": {
    ...
    inputs: [
      ...
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: r },
      { id: "seed", portType: "number", label: "Seed", required: !1, falParam: "seed", fieldType: "number", default: -1 }
    ]
  },
  "nano-banana-pro": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "1:1", options: d.filter((e) => e.value !== "auto") },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: b },
  ...
  "nano-banana-2": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "auto", options: S },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: b },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "safety_tolerance", portType: "text", label: "Safety Tolerance", required: !1, falParam: "safety_tolerance", fieldType: "select", default: "4", options: [
        { value: "1", label: "1 (strict)" },
  ...
  "kling-3-text": {
    ...
    inputs: [
      ...
      { id: "multi_prompt", portType: "multi_prompt", label: "Multi Prompt", required: !1, falParam: "multi_prompt", fieldType: "port" },
      { id: "negative_prompt", portType: "text", label: "Negative Prompt", required: !1, falParam: "negative_prompt", fieldType: "port" },
      { id: "duration", portType: "text", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "5", options: m },
      { id: "quality", portType: "text", label: "Quality", required: !1, falParam: "quality", fieldType: "select", default: "pro", options: n },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "16:9", options: [
        { value: "16:9", label: "16:9" },
        { value: "9:16", label: "9:16" },
        { value: "1:1", label: "1:1" }
  ...
  "kling-2-5-image": {
    ...
    inputs: [
      ...
      { id: "negative_prompt", portType: "text", label: "Negative Prompt", required: !1, falParam: "negative_prompt", fieldType: "port" },
      { id: "duration", portType: "text", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "5", options: T },
      { id: "cfg_scale", portType: "number", label: "CFG Scale", required: !1, falParam: "cfg_scale", fieldType: "range", default: 0.5, min: 0, max: 1, step: 0.1 }
    ]
  },
  "kling-first-last": {
  ...
  "ltx-2-video": {
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "image_url", portType: "image", label: "Image", required: !1, falParam: "image_url", fieldType: "port" },
      { id: "duration", portType: "number", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "6", options: u },
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "1080p", options: h },
      { id: "fps", portType: "number", label: "FPS", required: !1, falParam: "fps", fieldType: "select", default: "25", options: x },
      { id: "generate_audio", portType: "number", label: "Generate Audio", required: !1, falParam: "generate_audio", fieldType: "toggle", default: !0 }
    ]
  },
  "ltx-2-3-text": {
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "duration", portType: "number", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "6", options: u },
      { id: "quality", portType: "text", label: "Quality", required: !1, falParam: "quality", fieldType: "select", default: "pro", options: s },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "16:9", options: [
        { value: "16:9", label: "16:9" },
        { value: "9:16", label: "9:16" }
      ] },
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "1080p", options: o },
  ...
  "ltx-2-3-text-fast": {
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "duration", portType: "number", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: "6", options: f },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "16:9", options: [
        { value: "16:9", label: "16:9" },
        { value: "9:16", label: "9:16" }
      ] },
  ...
  "sora-2": {
    ...
    inputs: [
      ...
      { id: "quality", portType: "text", label: "Quality", required: !1, falParam: "quality", fieldType: "select", default: "pro", options: _ },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "auto", options: [
        { value: "auto", label: "Auto" },
        { value: "16:9", label: "16:9" },
        { value: "9:16", label: "9:16" }
  ...
  "elevenlabs-music": {
    ...
    inputs: [
      ...
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "mp3_44100_128", options: y }
    ]
  },
  "elevenlabs-tts": {
  ...
  "runpod-ltx25-session": {
    id: "runpod-ltx25-session",
    nodeType: "runpod-ltx25-session",
    ...
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "image_url", portType: "image", label: "First Frame", required: !1, falParam: "image_url", fieldType: "port" },
      { id: "duration_sec", portType: "number", label: "Duration", required: !1, falParam: "durationSec", fieldType: "select", default: "5", options: [
        { value: "5", label: "5 seconds" },
        { value: "10", label: "10 seconds" },
        { value: "15", label: "15 seconds" },
        { value: "20", label: "20 seconds" }
      ] },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspectRatio", fieldType: "select", default: "16:9", options: [
      ...
      { id: "generate_audio", portType: "number", label: "Generate Audio", required: !1, falParam: "generateAudio", fieldType: "toggle", default: !0 }
    ]
  },
  "runpod-sdxl-session": {
    id: "runpod-sdxl-session",
    nodeType: "runpod-sdxl-session",
    name: "SDXL Session",
    category: "image",
    description: "SDXL text-to-image on the active temporary RunPod session",
    outputType: "image",
    provider: "runpod",
    responseMapping: { path: "url" },
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "negative_prompt", portType: "text", label: "Negative Prompt", required: !1, falParam: "negativePrompt", fieldType: "port" },
      ...
      { id: "num_inference_steps", portType: "number", label: "Steps", required: !1, falParam: "steps", fieldType: "range", default: 25, min: 10, max: 100, step: 1 },
      { id: "guidance_scale", portType: "number", label: "Guidance", required: !1, falParam: "guidanceScale", fieldType: "range", default: 7.5, min: 1, max: 20, step: 0.5 },
      { id: "seed", portType: "number", label: "Seed", required: !1, falParam: "seed", fieldType: "number", default: -1 }
    ]
  },
  "runpod-qwen-image-edit-session": {
    id: "runpod-qwen-image-edit-session",
    nodeType: "runpod-qwen-image-edit-session",
    name: "Qwen Image Edit Session",
    category: "image-edit",
    description: "Qwen instruction-based image editing on the active temporary RunPod session",
    outputType: "image",
    provider: "runpod",
    responseMapping: { path: "url" },
    inputs: [
      { id: "prompt", portType: "text", label: "Edit Instruction", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "image_url", portType: "image", label: "Image", required: !0, falParam: "image_url", fieldType: "port" },
      { id: "extra_images", portType: "image", label: "Reference", required: !1, falParam: "image_urls", fieldType: "element-list", max: 2 },
      { id: "width", portType: "number", label: "Width", required: !1, falParam: "width", fieldType: "select", default: "", options: [
        { value: "", label: "Source width" },
        { value: "512", label: "512" },
        { value: "768", label: "768" },
        { value: "1024", label: "1024" },
        { value: "1280", label: "1280" }
      ] },
      { id: "height", portType: "number", label: "Height", required: !1, falParam: "height", fieldType: "select", default: "", options: [
        { value: "", label: "Source height" },
        { value: "512", label: "512" },
        { value: "768", label: "768" },
        { value: "1024", label: "1024" },
        { value: "1280", label: "1280" }
  ...
  "runpod-sdxl": {
    ...
    name: "Stable Diffusion XL (Serverless)",
    category: "image",
    description: "SDXL through a separately configured RunPod serverless endpoint",
    outputType: "image",
    provider: "runpod",
  ...
  "runpod-ltx-video": {
    ...
    name: "LTX Video (Serverless)",
    category: "video",
    description: "LTX-Video through a separately configured RunPod serverless endpoint",
    outputType: "video",
    provider: "runpod",
    runpodEndpointId: "",
  ...
  "runpod-qwen-image-edit": {
    ...
    name: "Qwen Image Edit (Serverless)",
    category: "image-edit",
    description: "Qwen image editing through a separately configured RunPod serverless endpoint",
    outputType: "image",
    provider: "runpod",
  ...
  "topview-image-auto": {
    ...
    name: "Image · Auto (live catalog)",
    category: "image",
    description: "Topview image generation or editing using the live recommended model",
    outputType: "image",
    provider: "topview",
    responseMapping: { path: "url" },
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "16:9", options: d },
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "1K", options: [
        { value: "1K", label: "1K" },
        { value: "2K", label: "2K" },
        { value: "4K", label: "4K" }
  ...
  "topview-video-auto": {
    id: "topview/video/auto",
    nodeType: "topview-video-auto",
    name: "Video · Auto (live catalog)",
    category: "video",
    description: "Topview video generation using the live recommended model",
    outputType: "video",
    provider: "topview",
    responseMapping: { path: "url" },
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: !0, falParam: "prompt", fieldType: "port" },
      { id: "image_url", portType: "image", label: "First Frame", required: !1, falParam: "image_url", fieldType: "port", mediaRole: "start_image" },
      { id: "extra_images", portType: "image", label: "Reference", required: !1, falParam: "image_urls", fieldType: "element-list", max: 8 },
      { id: "duration", portType: "number", label: "Duration", required: !1, falParam: "duration", fieldType: "select", default: 5, options: Array.from({ length: 27 }, (e, a) => ({ value: String(a + 4), label: `${a + 4}s` })) },
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "16:9", options: d },
      { id: "resolution", portType: "text", label: "Resolution", required: !1, falParam: "resolution", fieldType: "select", default: "720p", options: [
        { value: "720p", label: "720p" },
        { value: "1080p", label: "1080p" }
...
export {
  E as ALL_MODELS,
  n as KLING_V3_QUALITY_OPTS,
  k as LOCAL_MODEL_REGISTRY,
  s as LTX23_QUALITY_OPTS,
  M as MODEL_REGISTRY,
  R as POD_MODEL_REGISTRY,
  L as RUNPOD_MODEL_REGISTRY,
  _ as SORA2_QUALITY_OPTS,
  g as isKlingV3NodeType,
  P as resolveKlingV3ModelId,
  F as resolveVideoModelEndpoint,
  D as sanitizeVideoInputsForEndpoint,
  q as usesEndpointQualityRouting
};
