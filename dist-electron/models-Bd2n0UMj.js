...
function R(e, a, l) {
  ...
  return T(e) ? _(e === "kling-3-image" ? "image-to-video" : "text-to-video", i) : e === "sora-2" ? i === "standard" ? "fal-ai/sora-2/image-to-video" : "fal-ai/sora-2/image-to-video/pro" : e === "ltx-2-3-text" ? i === "fast" ? "fal-ai/ltx-2.3/text-to-video/fast" : "fal-ai/ltx-2.3/text-to-video" : e === "ltx-2-3-image" ? i === "fast" ? "fal-ai/ltx-2.3/image-to-video/fast" : "fal-ai/ltx-2.3/image-to-video" : l.hasImageInputs && a.altId ? a.altId : a.id;
}
function A(e, a, l) {
  P(e) && delete l.quality, e === "sora-2" && !a.endsWith("/pro") && (l.resolution === "1080p" || l.resolution === "true_1080p") && (l.resolution = "720p");
}
const s = Array.from({ length: 13 }, (e, a) => {
  ...
  { value: "48", label: "48" },
  { value: "50", label: "50" }
], q = [{ value: "25", label: "25" }, { value: "50", label: "50" }], o = [
  { value: "1080p", label: "1080p" },
  { value: "1440p", label: "1440p" },
  { value: "2160p", label: "4K" }
], x = [{ value: "1080p", label: "1080p" }, { value: "1440p", label: "1440p" }, { value: "2160p", label: "4K" }], t = [
...
], y = [{ value: "5", label: "5s" }, { value: "10", label: "10s" }], S = {
  "flux-dev": {
    id: "fal-ai/flux/dev",
    nodeType: "flux-dev",
    name: "FLUX Dev",
  ...
  "nano-banana-2": {
    ...
    inputs: [
      ...
      { id: "aspect_ratio", portType: "text", label: "Aspect Ratio", required: !1, falParam: "aspect_ratio", fieldType: "select", default: "auto", options: h },
      { id: "output_format", portType: "text", label: "Format", required: !1, falParam: "output_format", fieldType: "select", default: "png", options: f },
      { id: "num_images", portType: "number", label: "Num Images", required: !1, falParam: "num_images", fieldType: "number", default: 1, min: 1, max: 4, step: 1 },
      { id: "safety_tolerance", portType: "text", label: "Safety Tolerance", required: !1, falParam: "safety_tolerance", fieldType: "select", default: "4", options: [
        { value: "1", label: "1 (strict)" },
  ...
  "ltx-2-video": {
    ...
    inputs: [
      ...
      { id: "fps", portType: "number", label: "FPS", required: !1, falParam: "fps", fieldType: "select", default: "25", options: q },
      { id: "generate_audio", portType: "number", label: "Generate Audio", required: !1, falParam: "generate_audio", fieldType: "toggle", default: !0 }
    ]
  },
  "ltx-2-3-text": {
...
export {
  ...
  S as MODEL_REGISTRY,
  L as POD_MODEL_REGISTRY,
  M as RUNPOD_MODEL_REGISTRY,
  c as SORA2_QUALITY_OPTS,
  T as isKlingV3NodeType,
  _ as resolveKlingV3ModelId,
  R as resolveVideoModelEndpoint,
  A as sanitizeVideoInputsForEndpoint,
  P as usesEndpointQualityRouting
};
