...
const HIGGSFIELD_MODEL_REGISTRY = {
  "hf-soul-v2": {
    id: "text2image_soul_v2",
    nodeType: "hf-soul-v2",
    name: "Higgsfield Soul V2",
    category: "image",
    description: "Portraits / fashion / UGC / character stills",
    outputType: "image",
    provider: "higgsfield",
    responseMapping: { path: "output.url" },
    inputs: [
      { id: "prompt", portType: "text", label: "Prompt", required: true, falParam: "prompt", fieldType: "port" },
  ...
  "hf-nano-banana-pro": {
    id: "nano_banana_2",
    nodeType: "hf-nano-banana-pro",
    name: "Nano Banana Pro (Higgsfield)",
    category: "image",
    description: "Top-quality 4K image, text & diagrams",
    outputType: "image",
    provider: "higgsfield",
    responseMapping: { path: "output.url" },
    inputs: [
  ...
  "hf-gpt-image-2": {
    ...
    name: "GPT Image 2 (Higgsfield)",
    category: "image",
    description: "General / design image generation",
    outputType: "image",
    provider: "higgsfield",
    responseMapping: { path: "output.url" },
    inputs: [
  ...
  "hf-seedance-2": {
    id: "seedance_2_0",
    nodeType: "hf-seedance-2",
    name: "Seedance 2.0 (Higgsfield)",
    category: "video",
    description: "Reference-driven, multi-shot, motion-heavy video",
    outputType: "video",
    provider: "higgsfield",
    responseMapping: { path: "output.url" },
    inputs: [
  ...
  "hf-kling-3": {
    id: "kling3_0",
    nodeType: "hf-kling-3",
    name: "Kling v3.0 (Higgsfield)",
    category: "video",
    description: "Multi-shot video with audio & motion transfer",
    outputType: "video",
    provider: "higgsfield",
    responseMapping: { path: "output.url" },
    inputs: [
...
const ALL_MODELS = { ...MODEL_REGISTRY, ...KIE_MODEL_REGISTRY, ...LOCAL_MODEL_REGISTRY, ...RUNPOD_MODEL_REGISTRY, ...POD_MODEL_REGISTRY, ...HIGGSFIELD_MODEL_REGISTRY };
export {
  ALL_MODELS,
