...
export function buildProjectContext(params: {
  ...
  return [
    ...
    '',
    'CAPABILITIES',
    'Higgsfield generation is available: you can emit a generate_media skill action to create an image/video and place it on the timeline or in the bin. The user can also select a clip and press Cmd+Shift+Space for Quick Edit with AI, and add Higgsfield model nodes in the Create canvas.',
    '',
    'ELEMENTS',
    ...elementLines,
    '',
